 ...
 * @author mnarusze
 */
public class InputToNGramsAlgorithm extends InputParsingAlgorithm {
    private final static String NAME = "Input to NGrams";
    private final static String DESCRIPTION = "Translates input text to ngrams. Remember the ngram's position and number of occurences.";
     
    public InputToNGramsAlgorithm() {
    ...
    public void parseInput(WikiDocument document) {
        ...
        Set<NGram> nGrams = NGram.getNGrams(document.getInputText(), false, maxNgramLength);
